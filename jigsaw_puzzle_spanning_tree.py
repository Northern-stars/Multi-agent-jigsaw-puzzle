...
data_directory = "./../data/data_train/64/"
piece_size = 64
image_size = 512
grid_size = image_size/piece_size
num_of_pieces = (grid_size)**2
...
def maker():
    ...
    for i in range(image_size/piece_size):
        for j in range(image_size/piece_size):
...
print (len(list_mistake), list_mistake)